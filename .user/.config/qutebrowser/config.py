...
config.bind('<Alt-n>', 'fake-key <Tab>')
config.bind('<Alt-p>', 'fake-key <Shift-Tab>')
...
config.bind('<Ctrl-j>', 'run-with-count 8 scroll down')
config.bind('<Ctrl-k>', 'run-with-count 8 scroll up')
