...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_60_ansi(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,           KC_RALT, LT(1,KC_LEFT),    LT(2,KC_DOWN),    RCTL_T(KC_RGHT)
    ),
    ...
    [1] = LAYOUT_60_ansi(
        ...
        _______,          KC_NO,   KC_DEL,  KC_NO,   KC_NO,   KC_PGUP, KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,            _______,
        _______, _______, _______,                            KC_NO,                              _______, KC_NO,   KC_NO,   _______
    ),
    ...
    [2] = LAYOUT_60_ansi(
        ...
        _______,          KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_BTN1, KC_BTN3, KC_BTN2, KC_NO,            _______,
        _______, _______, _______,                            KC_NO,                              _______, KC_NO,   KC_NO,   _______
    ),
